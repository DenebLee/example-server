...
public class ClientMessageDto {
    ...
    public ClientMessageEntity toEntity() {
        return new ClientMessageEntity(id, agent_id, type, status, messageNum, send_time, sender_num, sender_callback, sender_name, content, created_at, last_modified_at);
    }
}
