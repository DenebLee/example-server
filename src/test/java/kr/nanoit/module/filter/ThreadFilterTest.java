...
//        expected.setPayload(new Payload(PayloadType.AUTHENTICATION, null, new Authentication(1, "test", "test", "test")));
//
//        // when
//        broker.publish(expected);
//        Thread.sleep(1000L);
...
//        InternalDataFilter expected = new InternalDataFilter();
//        expected.setMetaData(new MetaData(uuid));
//        expected.setPayload(new Payload(PayloadType.SEND, "123123", new Send(1, new Timestamp(System.currentTimeMillis()), "1234-55-535", "054-745-4242", "이정섭", "테스트중")));
//
//        // when
//        broker.publish(expected);
//        Thread.sleep(1000L);
